...
const ListTile = (props: any) => {
  return (
    <>
      <Link
        className="my-2 flex  w-2/3 justify-center "
        state={{ item: props.c }}
        to={props.c["name"]["common"]}
      >
        <div
          className="flex h-16  w-full items-center justify-center bg-cyan-600 rounded-lg shadow-cyan-700 shadow-md hover:bg-cyan-700"
